...
namespace PhantasmalTrack
{
    public class PlatformScript : MonoBehaviour
    {
        ...
        PhantasmalTrackPlayerController player;
        private void Awake()
        {
        ...
        private void Update()
        {
            ...
            if (player == null)
                player = FindObjectOfType<PhantasmalTrackPlayerController>();
            if (player != null && !player.isContinueJump)
            {
                Debug.Log(player.isContinueJump);
                return;
            }
