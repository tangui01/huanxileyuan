...
public class BrokenTreasure : MonoBehaviour, ICanTakeDamage
{
   ...
   public void DestroyAndGivePlayerProp()
    {
        TakeDamage(1000, Vector2.zero, SuperCommandoGameManager.Instance.Player.gameObject, Vector2.zero);
    }

    public void BoxHit()
    {
        TakeDamage(1000, Vector2.zero, SuperCommandoGameManager.Instance.Player.gameObject, Vector2.zero);
        SuperCommandoGameManager.Instance.Player.velocity.y = 0;
    }
    ...
    public void TakeDamage(int damage, Vector2 force, GameObject instigator, Vector3 hitPoint)
    {
        ...
        SuperCommandoSoundManager.Instance.PlaySfx(sound, volume);
