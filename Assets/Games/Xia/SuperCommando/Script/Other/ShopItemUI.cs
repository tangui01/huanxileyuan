...
public class ShopItemUI : MonoBehaviour
{
    ...
    void UpdateStatus()
    {
        ...
        {
            priceTxt.text = price + "";
            rewardedTxt.text = SuperCommandoGlobalValue.Instance.SaveLives + "";
        }
        else if (itemType == ITEM_TYPE.buyDart)
        {
            priceTxt.text = price + "";
            rewardedTxt.text = SuperCommandoGlobalValue.Instance.Bullets + "/" + SuperCommandoGlobalValue.Instance.getDartLimited();
        }
    ...
    private void AdsManager_AdResult(bool isSuccess, int rewarded)
    {
        ...
        if (isSuccess)
        {
            SuperCommandoGlobalValue.Instance.SavedCoins += rewarded;
            SuperCommandoSoundManager.Instance.PlaySfx(soundRewarded);
            UpdateStatus();
        }
    }
