...
public class GroupEnemySystem : MonoBehaviour {
    ...
    void Start () {
        mainCamera = FindObjectOfType<SuperCommandoCameraFollow>();
        //Invoke("Init", 1f);
    ...
    {
        SuperCommandoSoundManager.Instance.PlaySfx(soundClean);
        ...
        if(getKeyType == GETKEYTYPE.KEY)
        {
            ...
            SuperCommandoSoundManager.Instance.PlaySfx(soundGetKey);
        }
    ...
    IEnumerator OnTriggerEnter2D(Collider2D other)
    {
        ...
        SuperCommandoGameManager.Instance.Player.PausePlayer(true);
        ...
        SuperCommandoGameManager.Instance.Player.PausePlayer(false);
