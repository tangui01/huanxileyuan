...
public class GunManager : MonoBehaviour
{
   ...
   [ReadOnly] public List<GunTypeID> listGunPicked;
    ...
    public void ResetPlayerCarryGun()
    {
        ...
        foreach (var gun in listGun)
        {
            if (SuperCommandoGlobalValue.Instance.isPicked(gun))
            {
                AddGun(gun);
            }
        }
    ...
    public void SetNewGunDuringGameplay(GunTypeID gunID)
    {
        ...
        SuperCommandoGlobalValue.Instance.currentGunTypeID = gunID;
        foreach (var gun in listGun)
        {
    ...
    public void NextGun()
    {
        ...
        SuperCommandoGameManager.Instance.Player.SetGun(listGunPicked[currentPos]);
        SuperCommandoSoundManager.Instance.PlaySfx(SuperCommandoSoundManager.Instance.swapGun);
    }
