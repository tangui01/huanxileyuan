    ...
    public void Collect()
    {
        ...
        switch (itemType)
        {
            case Type.coin:
                ...
                SuperCommandoGlobalValue.Instance.SavedCoins += amount;
                break;
            case Type.dart:
                SuperCommandoGameManager.Instance.AddBullet(amount);
                break;
            case Type.hearth:
                SuperCommandoGameManager.Instance.Player.GiveHealth(amount, gameObject);
                break;
        }

        SuperCommandoSoundManager.Instance.PlaySfx(sound, soundVol);
