...
public class ChasingStone : MonoBehaviour, ICanTakeDamage {
    ...
    {
        direction = (new Vector3(SuperCommandoGameManager.Instance.Player.transform.position.x + XOffset, SuperCommandoGameManager.Instance.Player.transform.position.y + YOffset, SuperCommandoGameManager.Instance.Player.transform.position.z) - transform.position).normalized;
    ...
    public void TakeDamage(int damage, Vector2 force, GameObject instigator, Vector3 hitPoint)
    {
        ...
        SuperCommandoSoundManager.Instance.PlaySfx(destroySound, 0.7f);
