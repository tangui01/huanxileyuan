...
public class MeleeAttack : MonoBehaviour {
   ...
   [HideInInspector] public int combo = 2;
    ...
    {
        currentCombo = 0;
        extraDamage = (int) SuperCommandoGlobalValue.Instance.UpgradeItemPower(UPGRADE_ITEM_TYPE.sword.ToString());
    }
 ...
 //   }
    ...
    public void Check4Hit()
    {
        ...
        foreach (var hit in hits)
        {
            ...
            if (isProjectile)
            {
                ...
                isProjectile.LayerCollision = isProjectile.LayerCollision | SuperCommandoGameManager.Instance.enemyLayer;
            }
            else
    ...
    public void PlaySoundAttack(int combo)
    {
        ...
        {
            case 1:
                SuperCommandoSoundManager.Instance.PlaySfx(soundCombo1);
                break;
            case 2:
                SuperCommandoSoundManager.Instance.PlaySfx(soundCombo2);
                break;
            default:
                return;
        }
    ...
    public void ComboEnd()
    {
        ...
        currentCombo = 0;
        SuperCommandoGameManager.Instance.Player.anim.SetInteger("combo_", 0);
