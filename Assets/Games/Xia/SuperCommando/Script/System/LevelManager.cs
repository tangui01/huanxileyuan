...
public class LevelManager : MonoBehaviour {
	...
	SuperCommandoCameraFollow Camera;
    ...
    void Awake()
    {
        ...
        if (DefaultValue.Instance)
        {
            ...
            var _go = Resources.Load("LevelMap/Final Level/Level Map " + SuperCommandoGlobalValue.Instance.levelPlaying ) as GameObject;
	...
	void Start () {
		Camera = FindObjectOfType<SuperCommandoCameraFollow> ();
	}
}
