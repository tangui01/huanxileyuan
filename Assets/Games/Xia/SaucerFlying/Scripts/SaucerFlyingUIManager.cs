...
{
    public class SaucerFlyingUIManager : MonoBehaviour
    {
        ...
        void OnEnable()
        {
            SaucerFlyingGameManager.GameStateChanged += GameManager_GameStateChanged;
            SaucerFlyingScoreManager.ScoreUpdated += OnScoreUpdated;
        }
        ...
        void Update()
        {
            score.text = SaucerFlyingScoreManager.Instance.Score.ToString();
        ...
        {
            SaucerFlyingGameManager.Instance.StartGame();
        }

        public void EndGame()
        {
            SaucerFlyingGameManager.Instance.GameOver();
        }

        public void RestartGame()
        {
            SaucerFlyingGameManager.Instance.RestartGame(0.2f);
        }
        ...
        public void ShowStartUI()
        {
            ...
            if (SaucerFlyingGameManager.GameCount == 0)
            {
        ...
        {
            SaucerFlyingSoundManager.Instance.ToggleSound();
        }

        public void ToggleMusic()
        {
            SaucerFlyingSoundManager.Instance.ToggleMusic();
        }
        ...
        {
            if (SaucerFlyingSoundManager.Instance.IsSoundOff())
            {
        ...
        {
            if (SaucerFlyingSoundManager.Instance.IsMusicOff())
            {
