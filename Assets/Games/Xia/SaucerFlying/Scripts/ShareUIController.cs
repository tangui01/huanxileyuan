...
namespace SaucerFlying
{
    ...
    bool isUploadingGif;
        ...
        string ConstructShareMessage()
        {
            ...
            msg = msg.Replace("[score]", SaucerFlyingScoreManager.Instance.Score.ToString());
        ...
        {
            staticImage.transform.Find("FinalScore").GetComponent<TextMeshProUGUI>().text = GameObject.Find("Score").GetComponent<Text>().text;
#if EASY_MOBILE
        clipPlayerComp.Stop();
#endif
            if (ImgTex != null)
