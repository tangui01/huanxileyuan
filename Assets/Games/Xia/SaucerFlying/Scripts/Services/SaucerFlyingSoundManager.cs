...
{
    public class SaucerFlyingSoundManager : MonoBehaviour
    {
        public static SaucerFlyingSoundManager Instance { get; private set; }
        ...
        IEnumerator CRPlaySound(Sound sound, bool isSpecialSound = false, bool autoScaleVolume = true, float maxVolumeScale = 1f)
        {
            ...
            AudioManager.Instance.playerEffect1(sound.clip);
        ...
        public void PlayMusic(Sound music, bool loop = true)
        {
            ...
            // bgmSource.loop = loop;
            // bgmSource.Play();
            AudioManager.Instance.playerBGm(music.clip);
