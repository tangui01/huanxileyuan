...
public class ShipMainGun : MonoBehaviour {
	...
	void MainGunInverse()
	{
		...
		GetComponent<Animation>()["MainGunArrivingAnimationShip"].normalizedTime = 1;
		GetComponent<Animation>()["MainGunArrivingAnimationShip"].speed = -1;
		GetComponent<Animation>().Play();
	...
	void ResetAnimation()
	{
		...
		GetComponent<Animation>()["MainGunArrivingAnimationShip"].normalizedTime = 0;
		GetComponent<Animation>()["MainGunArrivingAnimationShip"].speed = 1;
...
//	}
	...
	void FireAway()
	{
		...
		if(!fired)
		{
			fireEvent.dontFire = true;
			GetComponent<Animation>()["MainGunArrivingAnimationShip"].normalizedTime = 0;
			GetComponent<Animation>()["MainGunArrivingAnimationShip"].speed = 2;
			if(!GetComponent<Animation>().isPlaying)
				GetComponent<Animation>().Play();
	...
	{
		fireEvent.bossLevel = bossShip.bossLevel;
