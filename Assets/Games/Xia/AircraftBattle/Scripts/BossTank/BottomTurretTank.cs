...
public class BottomTurretTank : MonoBehaviour {
	...
	public Transform wheelHit1;
	public Transform wheelHit2;
	public Transform wheelHit3;
	public Transform wheelHit4;
	public Transform wheelHit5;
	public Transform wheelHit6;
	public Transform wheelObjectDamaged1;
	public Transform wheelRendererDamaged2;
	//public Transform wheelWholeDamaged;
	...
	void Start () 
	{
		...
		{
			health = bossTank.turretBottomHealth;
			fireRate = 0.4f;
	...
	void TakeDamage(int damage)
	{
		...
		if(health<=0)
		{
			...
			wheelHit1.GetComponent<Renderer>().enabled = false;
			wheelHit2.GetComponent<Renderer>().enabled = false;
			wheelHit3.GetComponent<Renderer>().enabled = false;
			wheelHit4.GetComponent<Renderer>().enabled = false;
			wheelHit5.GetComponent<Renderer>().enabled = false;
			wheelHit6.GetComponent<Renderer>().enabled = false;
			...
			//wheelWholeDamaged.gameObject.SetActive(true);
			wheelObjectDamaged1.gameObject.SetActive(true);
			wheelRendererDamaged2.GetComponent<Renderer>().enabled = true;
	...
	IEnumerator Hit()
	{
		...
		wheelHit1.GetComponent<Renderer>().enabled = true;
		wheelHit2.GetComponent<Renderer>().enabled = true;
		wheelHit3.GetComponent<Renderer>().enabled = true;
		wheelHit4.GetComponent<Renderer>().enabled = true;
		wheelHit5.GetComponent<Renderer>().enabled = true;
		wheelHit6.GetComponent<Renderer>().enabled = true;
