...
public class SubmarineParkourResolutionManager : MonoBehaviour 
{
	static SubmarineParkourResolutionManager myInstance;
    ...
    public static SubmarineParkourResolutionManager Instance
    {
        get
        {
            if (myInstance == null)
                myInstance = FindObjectOfType(typeof(SubmarineParkourResolutionManager)) as SubmarineParkourResolutionManager;
	...
	public void SetResolutionSetting(GameObject[] scalable, GameObject[] shopElements, GameObject[] leftElements, GameObject[] rightElements, GameObject h)
	{
		...
		SubmarineParkourLevelGenerator.Instance.SetHangarPos(hangar);
		
		//Set the submarine starting and main position
		GameObject sub = SubmarineParkourPlayerManager.Instance.gameObject;
		temp = sub.transform.position;
		temp.x = subStartP;
		sub.transform.position = temp;
		
		SubmarineParkourPlayerManager.Instance.SetPositions(subStartP, subPos);
	}
