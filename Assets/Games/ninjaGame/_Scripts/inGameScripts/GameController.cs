...
namespace ninjaGame
{
	public class GameController : MonoBehaviour
	{
		...
		public void CreateNewWorld()
		{
			...
			GameObject obj = GameObject.Instantiate(choosenWorldObj, new Vector3(nextBlockDistance * blockCount, 0, 0),
		...
		public void CreateNewCoins()
		{
			...
			GameObject obj = GameObject.Instantiate(NewCoins[Random.Range(0, NewCoins.Length)],
				new Vector3(Player.position.x + 20, Random.Range(1.0f, 2.5f), Player.position.z),
				Quaternion.identity) as GameObject;
			Destroy(obj, 15f);
		...
		public void CreatePowerUps()
		{
			...
			GameObject obj = GameObject.Instantiate(PowerUps[Random.Range(0, PowerUps.Length)],
				new Vector3(Player.position.x + 40, Random.Range(1.0f, 1.5f), Player.position.z),
				Quaternion.identity) as GameObject;
			Destroy(obj, 15f);
		...
		public void CreateZombies()
		{
			if (isplayerDaed)
				return;
			GameObject obj = Instantiate(Zombies[Random.Range(0, Zombies.Length)],
				new Vector3(Player.position.x + 30, 0, Player.position.z),Quaternion.Euler(0,-90,0)) as GameObject;
			Destroy(obj, 20.0f);
		}
		...
		public void CreateObsticles()
		{
			...
			GameObject obj = GameObject.Instantiate(Obsticles[Random.Range(0, Obsticles.Length)],
				new Vector3(Player.position.x + 35, 0, Player.position.z), Quaternion.identity) as GameObject;
