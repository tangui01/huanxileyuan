...
public class OngGiaScript : MonoBehaviour {
    ...
    void KeoCau()
    {
        if(GameObject.Find("dayCau").GetComponent<DayCauScript>().typeAction == TypeAction.KeoCau)
        {
            ...
            if((LuoiCauScript.instance.speed < 1.5f) && !GoldMinerGameManager.instance.power)
            {
    ...
    public void Happy(bool isPower=false)
    {
        anim.SetBool("Happy", true);
        GamePlayScript.instance.PlaySound(8);
    ...
    public void Angry()
    {
        ...
        GamePlayScript.instance.PlaySound(7);
