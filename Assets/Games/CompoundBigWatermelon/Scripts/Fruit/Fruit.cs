...
{ 
	...
	public class Fruit : MonoBehaviour
	{
        ...
        public void Init(FruitSeriesType fruitSeriesType, Action<Collision2D, Fruit> onCompoundAction,AudioManager audioManager)
        {
            DisableFruit();
        ...
        private void OnCollisionEnter2D(Collision2D collision)
        {
            ...
            if (this.FruitType != FruitSeriesType.BigWatermelon)
            {
                ...
                if (otherRuit != null)
                {
                    if (!global::AudioManager.Instance.Effect2ISPalyer())
                    {
            ...
            if (collision.gameObject.CompareTag("Grand")&&!global::AudioManager.Instance.Effect2ISPalyer())
            {
                m_AudioManager.PlayerCollisionGrandSound();
            }
        }
