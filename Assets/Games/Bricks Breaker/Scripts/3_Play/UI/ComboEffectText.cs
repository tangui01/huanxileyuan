...
public class ComboEffectText : MonoBehaviour {
    ...
    public void AllClear () {
        ...
        if (CtrGame.instance.isAllClear) {
            //Every clear second
            if (allClearCount == 2) {
                BricksBreakerSoundManager.Instance.PlayEffect(SoundList.sound_play_sfx_allclearbonus2);
            } else {
                BricksBreakerSoundManager.Instance.PlayEffect(SoundList.sound_play_sfx_allclearbonus1);
            }
    ...
    IEnumerator AllClearCo () {
        ...
        BricksBreakerSoundManager.Instance.PlayEffect(SoundList.sound_play_sfx_lucky);
    ...
    IEnumerator LuckyCo () {
        ...
        int score = 200;
        CtrGame.instance.turnScore += score;
        BricksBreakerSoundManager.Instance.PlayEffect(SoundList.sound_play_sfx_allclearbonus0);

        fxShot.Play();
        BricksBreakerPlayManager.Instance.CameraSound();
