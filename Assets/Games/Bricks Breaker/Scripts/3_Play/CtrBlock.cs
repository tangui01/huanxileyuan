...
public class CtrBlock : MonoBehaviour
{
    ...
    public void SpwanBlock(int numY = 0, int health = 0)
    {
        ...
        BlockGroup blockGroup = BricksBreakerPoolManager
    ...
    {
        BricksBreakerSoundManager.Instance.PlayEffect(SoundList.sound_play_sfx_block_down);
    ...
    {
        BricksBreakerSoundManager.Instance.PlayEffect(SoundList.sound_play_sfx_revival);
