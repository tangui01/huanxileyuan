...
public class PanelBase : MonoBehaviour
{
    ...
    public virtual void Open()
    {
        ...
        BricksBreakerPlayManager.Instance.panelBase = this;
    ...
    public virtual void Close()
    {
        ...
        BricksBreakerPlayManager.Instance.panelBase = null;
        BricksBreakerSoundManager.Instance.PlayEffect(SoundList.sound_common_btn_close);
