...
public class UILocalizeEditor : Editor
{
	...
	public override void OnInspectorGUI ()
	{
		...
		if(script.GetComponent<UI2DSprite>() != null) {
			NGUIEditorTools.DrawProperty("SpriteAtlas", serializedObject, "mSpriteAtlas");
		}
		if(script.GetComponent<UISprite>() != null || script.GetComponent<UI2DSprite>() != null)
			NGUIEditorTools.DrawProperty("IsPixelPerfect", serializedObject, "mIsPixelPerfect");
